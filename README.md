# Move Storage on Solana

The Solana program provided here mimics Move storage operations.

The client which invokes the Solana program is written in Rust.
Contrary to what you might guess the most complicated part of writing
a smart contract in Solana is the client.

## Getting started

Run a local Solana validator by running:
...
```
Connected to remote solana node running version (1.17.0).
           1418720 lamports are required for this transaction.
499999999176727640 lamports are owned by payer.
Object account created: Pubkey CZtHa7rMedM3RYkV1D57B8jwxb8UYStWWiTFmM316NsQ Account { lamports: 919720, data.len: 4, owner: Hzq8yBUYPrvYzLnbfZHvw1ReyQw3pWtgzHEAtrQqBPNJ, executable: false, rent_epoch: 18446744073709551615, data: 00000000 }
Color object created: Pubkey CZtHa7rMedM3RYkV1D57B8jwxb8UYStWWiTFmM316NsQ Account { lamports: 919720, data.len: 4, owner: Hzq8yBUYPrvYzLnbfZHvw1ReyQw3pWtgzHEAtrQqBPNJ, executable: false, rent_epoch: 18446744073709551615, data: 01ff00ff }
499999999175797920 lamports are owned by payer.
```
...
to the blockchain is read from the Solana config in `config.yml`.
